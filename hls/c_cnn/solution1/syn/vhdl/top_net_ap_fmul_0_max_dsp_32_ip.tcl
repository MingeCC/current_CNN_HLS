...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name top_net_ap_fmul_0_max_dsp_32
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name top_net_ap_fmul_0_max_dsp_32 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips top_net_ap_fmul_0_max_dsp_32] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files top_net_ap_fmul_0_max_dsp_32.xci]
generate_target {synthesis simulation} [get_files top_net_ap_fmul_0_max_dsp_32.xci]
