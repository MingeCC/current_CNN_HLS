...
// ==============================================================
#ifndef __top_net_fcmp_32nsdEe__HH__
#define __top_net_fcmp_32nsdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_net_fcmp_32nsdEe) {
    ...
    SC_CTOR(top_net_fcmp_32nsdEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
