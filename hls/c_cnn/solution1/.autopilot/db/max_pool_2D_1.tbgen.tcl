...
set C_modelName {max_pool_2D.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_r float 32 regular {array 4704 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ in_r_address0 sc_out sc_lv 13 signal 0 } 
	{ in_r_ce0 sc_out sc_logic 1 signal 0 } 
	{ in_r_q0 sc_in sc_lv 32 signal 0 } 
	{ in_r_address1 sc_out sc_lv 13 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_r_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "in_r", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.top_net_fcmp_32nsdEe_U10", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	in_r { ap_memory {  { in_r_address0 mem_address 1 13 }  { in_r_ce0 mem_ce 1 1 }  { in_r_q0 mem_dout 0 32 }  { in_r_address1 MemPortADDR2 1 13 }  { in_r_ce1 MemPortCE2 1 1 }  { in_r_q1 MemPortDOUT2 0 32 } } }
