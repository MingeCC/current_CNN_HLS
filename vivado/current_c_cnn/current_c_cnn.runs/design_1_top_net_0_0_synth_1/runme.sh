...
HD_PWD='F:/Desktop/PRJ/current_cnn/vivado/current_c_cnn/current_c_cnn.runs/design_1_top_net_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_top_net_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_top_net_0_0.tcl
